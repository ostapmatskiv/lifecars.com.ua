...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= SERVER_URL ?>style/ws__main.css?v=1.1">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css">
	<link rel="stylesheet" type="text/css" href="<?= SERVER_URL ?>assets/magnific-popup/magnific-popup.css">
	<link rel="stylesheet" type="text/css" href="<?= SERVER_URL ?>style/style.css?v=0.5.5">
</head>
...
<body class="<?= $_SESSION['alias']->alias ?>">
	...
	<script type="text/javascript" src="<?= SERVER_URL ?>js/site.js?v1.8"></script>
