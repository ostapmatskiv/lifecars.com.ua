<form action="<?=SITE_URL?>admin/<?=$_SESSION['alias']->alias?>/send_mail" class="right" onsubmit="$('#saveing').css('display', 'block');">
    <input type="hidden" name="cart_id" value="<?=$cart->id?>">
    <button class='btn btn-warning btn-xs' title="<?=$cart->user_email?>"><i class="fa fa-envelope" aria-hidden="true"></i> Відправити повторно платіжні реквізити</button>
</form>
