...
<?php
    ...
    if($_SESSION['language'])
    	$_SESSION['alias']->js_load[] = "assets/datepicker/i18n/datepicker.{$_SESSION['language']}.js";
    else
...
<script>
	function promo_add_init() {
		var datepicker_config = { language: '<?=$_SESSION['language']?>', 'startDate': '<?=date('d.m.Y')?>', 'autoHide':true };
