...
class install
{
	...
	public $sub_menu = array("add" => "Додати товар", "all" => "До всіх товарів", "groups" => "Групи", "options" => "Властивості", "promo" => "Акції");
	public $sub_menu_access = array("add" => 2, "all" => 2, "groups" => 2, "options" => 1, "promo" => 2);
